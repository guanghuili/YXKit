...
#define ArrowCloseImage @"arrow_down"
#define ArrowOpenupImage @"arrow_up"
...
-(void) layoutSuperView
{
    ...
    [UIView beginAnimations:@"LayoutSuperViewAnimation" context:nil];
    
    UIView *superView = self.superview;
    
    NSInteger subviewCount = superView.subviews.count;
    ...
    for (NSInteger i = viewIndex ; i < subviewCount ; i++)
    {
    ...
    {
        superView.height = preViewBottom;
    }
